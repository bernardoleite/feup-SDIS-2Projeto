...
public class NotificationExitChannel implements Runnable{
	...
	public NotificationExitChannel(String address, int port, String email, String message) throws UnknownHostException{
	...
	public NotificationExitChannel(String address, int port) throws UnknownHostException{
	...
	public void receiveMessage(String email) throws UnknownHostException, InterruptedException{
		...
		String receivedEmail = "";
			try{
				...
				sendMessage(Messages.sendACKExitTravel(email).getBytes());
	...
	public void run(){
		...
		try{
			while(true){
				...
				if(receivedAction.equals("ListenedExitTravel") && receivedEmail.equals(email)) {
