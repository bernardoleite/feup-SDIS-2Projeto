...
public class NotificationAddChannel implements Runnable{
	...
	public NotificationAddChannel(String address, int port, String email, String message) throws UnknownHostException{
	...
	public NotificationAddChannel(String address, int port) throws UnknownHostException{
	...
	public void receiveMessage(String email) throws UnknownHostException, InterruptedException{
		...
		String receivedEmail = "";
			try{
				...
				sendMessage(Messages.sendACKAddPassenger(email).getBytes());
	...
	public void run(){
		...
		try{
			while(true){
				...
				if(receivedAction.equals("ListenedAddPassenger") && receivedEmail.equals(email)) {
